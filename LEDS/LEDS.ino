...
void loop() {
  ...
  if (MovingSnakeSpeed > 0)
  {
    ...
    if (CurrentTimeSample < OldSnakeTimeSample)//In case of millis rollover and restarting
    {
      OldSnakeTimeSample = 0;
    }
  ...
  {
    int CurrentTimeSample = millis();
    if (CurrentTimeSample < OldPatternTimeSample) //In case of millis overflowing and restarting
    {
...
//This function stops all moving effects
